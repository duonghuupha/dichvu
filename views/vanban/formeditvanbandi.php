...
<script type="text/javascript" src="<?php echo URL.'/public/javascript/vanban/vanbandi.js' ?>"></script>
<script>
$(function(){
            ...
            <div class="row">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Số văn bản" id="so_vanban" 
                                name="so_vanban" value="<?php echo $jsonObj[0]['so_vanban'] ?>" required>
                            </div>
                            <hr />
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    name="ngay_vanban" value="<?php echo date("d-m-Y", strtotime($jsonObj[0]['ngay_vanban'])) ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <input class="form-control" placeholder="Tiêu đề văn bản" id="title" 
                                name="title" value="<?php echo $jsonObj[0]['title'] ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="btn btn-default btn-file">
                                    ...
                                    <input type="file" name="file_at" name="file_at" onchange="ValidateFileSize(this)"/>
                                    <i id="tenfile"></i>
                                </div>
                        ...
                        <div class="box-footer">
                            ...
                            <button type="button" class="btn btn-danger" onclick="window.location.href='<?php echo URL.'/vanban/vanbandi' ?>'">
