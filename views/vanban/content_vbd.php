...
<table id="example2" class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo URL.'/vanban/detailvbd?id='.$row['id'] ?>">
                    <?php echo $row['title'] ?>
                </a><br />
                <small>
                    Số đến: <?php echo $row['so_den'] ?> - Ngày đến: <?php echo date("d-m-Y", strtotime($row['ngay_den'])) ?><br/>
            ...
            <td style="text-align:center">
                ...
                ?>
                <button type="submit" class="btn btn-primary" onclick="edit_vanbanden(<?php echo $row['id'] ?>)">
                ...
                ?>
                <button type="submit" class="btn btn-danger" onclick="del_vanbanden(<?php echo $row['id'] ?>)">
...
if($jsonObj['total'] > $perpage){
    ...
    $createlink = $convert->createLinks_event($jsonObj['total'], $perpage, $pagination['number'], 'view_page_vanbanden', 1);
?>
