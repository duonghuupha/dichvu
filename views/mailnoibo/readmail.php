<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Mail nội bộ
            <small>Email nội bộ của trường học</small>
        </h1>
    </section>
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="<?php echo URL.'/mailnoibo/compose' ?>" class="btn btn-primary btn-block margin-bottom">Soạn mail</a>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            <button type="button" class="btn btn-default"><i class="fa fa-reply"></i> Trả lời</button>
