<script type="text/javascript" src="<?php echo URL.'/public/javascript/hocsinh/import.js' ?>"></script>
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Nhập danh sách từ file Excel
            <small>
                Hỗ trợ người dùng nhập danh sách học nhanh chóng
            </small>
        </h1>
    </section>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Lựa chọn lớp học</label>
                                    <select class="form-control" data-placeholder="Lựa chọn lớp học" 
                                    id="lop_hoc" name="lop_hoc" onchange="check_lophoc()">
                                    </select>
                                </div>
                            </div>
                            <hr/>
                ...
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">
                            Danh sách học sinh
                            <small>
                                Dòng được in màu đỏ là học sinh trùng mã 
                            </small>
                        </h3>
                        <div class="box-tools">
